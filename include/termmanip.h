...
enum Window_flags {TM_FLAG_ECHO = 0b0000000000000010, TM_FLAG_CURSOR_VISIBLE = 0b0000000000000100,TM_FLAG_SCROLL = 0b0000000000001000, TM_FLAG_SHADOW = 0b0000000000010000, TM_FLAG_MOUSE_INPUT = 0b0000000000100000, TM_FLAG_TERMINAL_INPUT = 0b0000000001000000, TM_FLAG_WRAP_TEXT = 0b0000000010000000,TM_FLAG_ALL = 0b1111111111111111};
