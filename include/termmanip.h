...
#define TM_ATTRIB_DIM 2
#define TM_ATTRIB_ITALIC 3
#define TM_ATTRIB_UNDERLINE 4
#define TM_ATTRIB_BLINKING 5
#define TM_ATTRIB_HIGHLIGHT 7
#define TM_ATTRIB_INVISIBLE 8
#define TM_ATTRIB_CROSSOUT 9
